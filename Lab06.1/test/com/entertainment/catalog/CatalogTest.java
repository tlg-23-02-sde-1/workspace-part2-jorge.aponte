...
public class CatalogTest {
    ...
    @Test
    public void createListOfTVByVolumes() {
        ...
        // Using streams
        tvList.stream().sorted(Comparator.comparing(Television::getVolume))
    ...
    @Test
    public void findLoudestTv_usingStream() {
        List<Television> tvMax = Catalog.getInventory().stream()
                .sorted(Comparator.comparing(Television::getVolume).reversed())
                .collect(Collectors.toList());
        Television loudest = tvMax.get(0);
        System.out.println(loudest);
    }

    @Test
    public void findLoudestTv() {
