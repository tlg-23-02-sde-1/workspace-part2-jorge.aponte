...
public class Catalog {
    ...
    public static Collection<Television> findByBrand(String brand) {
        ...
        return result;
// Another way to write this using stream() API
//        Collection<Television> sorted = catalog.stream()
//                .filter(catalog -> catalog.getBrand().equals(brand))
...
//        return sorted;
    ...
    static {
        ...
        catalog.add(new Television("Sony", 50));    // #1 Sony
        catalog.add(new Television("Zenith", 33));
        catalog.add(new Television("RCA", 50));     // #1 RCA
        ...
        catalog.add(new Television("RCA", 50));     // #2 RCA
        catalog.add(new Television("Sony", 94));
        catalog.add(new Television("RCA", 50));     // #3 RCA
        catalog.add(new Television("Sony", 50));    // #2 Sony
        catalog.add(new Television("Hitachi", 50)); // #1 Hitachi
        ...
        catalog.add(new Television("Hitachi", 50)); // #2 Hitachi
        catalog.add(new Television("RCA", 4));
        catalog.add(new Television("RCA", 50));     // #4 RCA
        catalog.add(new Television("RCA", 50));     // #5 RCA
        ...
        catalog.add(new Television("RCA", 50));     // #6 RCA
    }
}
